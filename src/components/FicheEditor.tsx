      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            onClick={save}
            disabled={saving}
            className="flex items-center gap-1.5 bg-[var(--color-ink)] text-[var(--color-parchment)] px-3 sm:px-3.5 py-2 rounded text-[13px] hover:opacity-90 disabled:opacity-50"
          >
